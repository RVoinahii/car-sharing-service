...
public class PaymentNotificationTemplates {
    public EnumMap<NotificationRecipient, String> createSuccessfulPaymentMessages(
            Payment payment) {
    ...
    public EnumMap<NotificationRecipient, String> createPaymentCancelMessages(Payment payment) {
        EnumMap<NotificationRecipient, String> messages = new EnumMap<>(
                NotificationRecipient.class);
    ...
    public EnumMap<NotificationRecipient, String> createRenewPaymentMessage(Payment payment) {
        EnumMap<NotificationRecipient, String> messages = new EnumMap<>(
                NotificationRecipient.class);
